...
- Discover groups its compact introduction, catalog buttons, a featured item, and independent streaming-style shelves. Anime uses honest MAL-backed labels—Popular now, Currently airing, and Seasonal releases—movies and TV use Popular now, Trending this week, and Latest releases, and Games use Popular and Latest releases because no configured game Provider exposes trending. Search has its own form, vertical results, and details. Account holds authentication.
